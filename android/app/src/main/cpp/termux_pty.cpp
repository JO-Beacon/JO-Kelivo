...
// JNI 类：io.github.jobeacon.joaiclient.workspace.PtyJni
...
Java_io_github_jobeacon_joaiclient_workspace_PtyJni_createSubprocess(
        JNIEnv *env,
        jclass,
        jstring cmd,
        jstring cwd,
...
Java_io_github_jobeacon_joaiclient_workspace_PtyJni_setPtyWindowSize(
...
extern "C" JNIEXPORT jint JNICALL
Java_io_github_jobeacon_joaiclient_workspace_PtyJni_waitFor(JNIEnv *, jclass, jint pid) {
    int status = 0;
...
extern "C" JNIEXPORT void JNICALL
Java_io_github_jobeacon_joaiclient_workspace_PtyJni_close(JNIEnv *, jclass, jint fd) {
    close(fd);
}
