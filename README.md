...
🔗 [下载最新版本的JO-Kelivo](占位符/releases/latest)
...
[![Star History Chart](占位符/star-history.svg)](占位符/star-history)

# 许可证

本项目采用 AGPL-3.0 许可证 - 查看 [LICENSE](LICENSE) 文件了解详情。

本项目作为 [原版 Kelivo](https://github.com/Chevey339/kelivo) 的修改版本，继续按 GNU AGPL-3.0 发布。分发二进制文件时，应同时提供对应源代码。

# 联系我们

- Issue: [GitHub Issues](占位符/issues)
