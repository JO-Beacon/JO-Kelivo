...
当前代码版本：`0.1.14+14`（待发布）。当前实现基座：Kelivo `1.2.5+72`。GitHub 上最新已公开 Release 为 `0.1.13+13`。

| 版本 | 状态 | 发布正文 |
| --- | --- | --- |
| `0.1.14+14` | 待发布 | [.github/release-notes/0.1.14+14.md](.github/release-notes/0.1.14+14.md) |
