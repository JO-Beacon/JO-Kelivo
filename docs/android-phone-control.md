...
1. 在 Android 无障碍设置中启用「JO-AIClient 手机控制」。页面会分别显示未启用、已启用但未连接、已连接三种状态。
...
cd android
./gradlew :app:testDebugUnitTest --tests io.github.jobeacon.joaiclient.PhoneControlServiceTest
```
