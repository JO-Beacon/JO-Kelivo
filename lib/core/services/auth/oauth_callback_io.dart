...
final class _AndroidOAuthCallback implements OAuthCallback {
  _AndroidOAuthCallback(Uri authorizationServer)
    : redirectUri = Uri(
        ...
        // 这个 URI 已注册到各授权服务；共用回调实现时不得改动
        // 已注册的重定向地址（本仓库用自己的 scheme）。
...
<html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>JO-AIClient</title></head>
<body><p>Authorization received. You may close this window and return to JO-AIClient.</p>
</body></html>''';
