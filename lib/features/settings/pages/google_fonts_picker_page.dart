...
class _GoogleFontsPickerPageState extends State<GoogleFontsPickerPage> {
  ...
  Future<void> _load({bool refresh = false}) async {
    ...
    try {
      ...
      debugPrint('[GoogleFontsPicker] $error\n$stack');
  ...
  Future<void> _apply() async {
    ...
    try {
      ...
      debugPrint('[GoogleFontsPicker] Apply failed: $error\n$stack');
      // 保留预览并显示失败，允许重试；不能把导入失败报成成功。
    }
    if (!mounted) return;
    setState(() {
      _applying = false;
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: IosIconButton(
            ...
            icon: Lucide.X,
            onTap: _applying ? null : () => Navigator.of(context).pop(),
          ),
          actions: [
            IosIconButton(
              minSize: 44,
              ...
              onTap: _loading || _downloading || _applying
                  ? null
                  : () => _load(refresh: true),
            ),
          ],
                              ...
                              Wrap(
                                ...
                                children: [
                                  ...
                                  IosTileButton(
                                    ...
                                    label: l10n.statsPageCustomRangeApply,
                                    onTap: _apply,
                                  ),
                                ],
                              ),
