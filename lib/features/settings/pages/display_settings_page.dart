          ...
          _iosSectionCard(
            children: [
              ...
              _iosSwitchRow(
                ...
                // 上游把该行说明放在 tip（问号图标）里，本仓库没有那个控件，
                // 改放 subtitle 直接显示。
                subtitle: l10n.displaySettingsPageShowProducedFilesSubtitle,
          ...
          _iosSectionCard(
            children: [
              ...
              _iosSwitchRow(
                ...
                subtitle:
                    l10n.displaySettingsPageCollapseLongUserMessagesSubtitle,
...
class _LongPasteAsFileThresholdRowState
  ...
  Widget build(BuildContext context) {
    ...
    final sp = context.watch<SettingsProvider>();
    if (!_focusNode.hasFocus) {
      final text = '${sp.longPasteAsFileThreshold}';
