...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get backupPageChatboxModernGroupName => 'Chatbox Import (>=1.22)';
  ...
  String legacyMemoryModeCacheWarning(String token) {
    return 'Legacy mode writes all memories and the current time into the system prompt every turn, so prompt cache cannot hit and long chats cost more.';
  }
  ...
  @override
  String get workspaceEnvRestartBanner => 'Restart JO-AIClient to finish';
  ...
  @override
  String get backgroundTaskTitle => 'JO-AIClient task';
  ...
  @override
  String get backgroundIconDefault => 'JO-AIClient icon';
  ...
  String startupRecoverySnapshotConfirm(String when) {
    return 'Restore chats and settings from $when? Changes made after this snapshot will not be included. Existing attachment files and the snapshot will be kept. JO-AIClient will restart to complete the restore.';
  }
  ...
  @override
  String get mcpServerEditSheetNameHint => 'My MCP';
  ...
  @override
  String get mcpServerEditSheetStdioEnvValueHint => 'Value';
