...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get homePageDeleteMessage => '删除当前分支';

  @override
  String get homePageDeleteMessageConfirm => '确定要删除当前分支及其后续消息吗？其他分支会保留。';

  @override
  String get homePageDeleteMessageOnly => '删除此条消息';
  ...
  @override
  String get backupPageChatboxModernGroupName => 'Chatbox 导入（≥1.22）';

  @override
  String get backupPageChatboxModernStarredGroupName => 'Chatbox 导入（≥1.22）·置顶';

  @override
  String get backupPageChatboxModernNote =>
      'Chatbox 的人设与智能体笔记不会导入；会导入供应商、助手、会话、消息与文件。';
  ...
  @override
  String get messageEditPageSaveAsBranch => '保存为新分支';

  @override
  String get messageEditPageSaveAsBranchAndSend => '保存为新分支并发送';
  ...
  @override
  String get messageEditTrimWhitespace => '清理首尾空白';
  ...
  @override
  String get messageEditCloseConfirmTitle => '关闭而不保存？';

  @override
  String get messageEditCloseConfirmContent => '当前修改将被丢弃。';
  ...
  @override
  String get messageMoreSheetCopyFromHereWithBranches => '从此处复制到新会话（保留分支）';
  ...
  @override
  String get conversationForkFailed => '无法复制会话';
  ...
  String sideDrawerMoveSelectedWithSkippedSnackbar(int moved, int skipped) {
    return '已移动 $moved 个话题，跳过 $skipped 个正在生成的话题';
  }
  ...
  @override
  String get modelDetailSheetOpenRouterWebFetchTool => '网页获取';

  @override
  String get modelDetailSheetOpenRouterWebFetchToolDescription =>
      '允许 OpenRouter 代模型获取网页内容。';
  ...
  String get modelDetailSheetOpenRouterShellToolDescription =>
      '在 Responses 模式中允许 OpenRouter 服务端 Shell 工具。';
  ...
  @override
  String get miniMapFullWindow => '全窗口显示';

  @override
  String get miniMapRestoreWindow => '恢复窗口大小';

  @override
  String get miniMapActualSizeTooltip => '100%';

  @override
  String get miniMapFitHorizontalTooltip => '横向全览';
  ...
  String get memorySettingsInjectionMaxItemsSubtitle =>
      '某类记忆超过此上限时，只注入最新条目，其余内容可通过 memory_search_profile 查询。数值越大越完整，但会占用更多 token。';
  ...
  @override
  String get memoryPromptEditMigrateSubtitle => '迁移时使用模型整理记忆措辞';

  @override
  String get memorySettingsMigrationBatchSizeSubtitle =>
      '每次模型请求处理的旧版记忆数量（1-24）';
  ...
  String get legacyMemoryMigrationContentOrganizeDescription =>
      '模型使用可编辑的迁移提示词，对每条记忆分类并重新整理措辞。';

  @override
  String get legacyMemoryMigrationBatchSize => '每批条数';
  ...
  String legacyMemoryModeCacheWarning(String token) {
    return '旧版会把全部记忆内容与当前时间写进系统提示词，每轮都在变，无法命中 prompt cache，长对话成本更高。';
  }
  ...
  String get backupIncludeLocalSettingsOnSubtitle =>
      '窗口大小与位置、桌面快捷键、聊天字号等本机专属设置随备份一起带走。';
  ...
  String get storageSpaceClearDisplacedDatabasesConfirmMessage =>
      '确定删除这些保留的旧数据库吗？它们是 JO-AIClient 重建数据库时留下的，可能是那些聊天记录和设置仅存的一份。删除后无法恢复。';
  ...
  String get startupRecoveryDangerBody =>
      '重置会永久删除本设备上 JO-AIClient 的数据库。请先导出数据副本——重置同时会销毁排查根本问题所需的证据。';
  ...
  String backupPageForwardCompatBody(int backupVersion, int currentVersion) {
    return '这份备份由更新版本的 JO-AIClient 创建（数据格式 $backupVersion，当前版本支持 $currentVersion），且未声明旧版本能否读取。\n\n你可以继续导入：当前版本不认识的内容会被跳过，备份文件本身不会被修改。但如果新版本改变了已有数据的存储方式，部分内容可能会被错误导入。\n\n更稳妥的做法是先升级 JO-AIClient。';
  }
  ...
  String get backupPageSchemaTooNewMessage =>
      '这份备份由更新版本的 JO-AIClient 创建，当前版本无法读取。请先升级 JO-AIClient 后重试。';
  ...
  @override
  String get workspaceEnvRestartBanner => '请重启 JO-AIClient 以完成安装';
  ...
  String get workspaceEnvNativeExplanation =>
      '在桌面端，JO-AIClient 使用系统终端，而不是 Linux 沙箱。';
  ...
  @override
  String get workspaceDesktopManagedHint => '由 JO-AIClient 为此项目创建并管理文件夹。';
  ...
  String get workspaceExternalStorageMessage =>
      '工作区和 Shell 需要直接读写外部文件夹，请在 Android 系统设置中允许 JO-AIClient 访问文件。Android 11 及以上需开启“所有文件访问权限”，然后选择要挂载的本地文件夹。';
  ...
  @override
  String get backgroundTaskTitle => 'JO-AIClient 任务';
  ...
  @override
  String get backgroundIconDefault => 'JO-AIClient 图标';
  ...
  String get startupRecoverySnapshotBody =>
      '即使数据库无法打开，也可以选择本机快照恢复聊天和设置。请勿卸载 JO-AIClient，卸载会一并删除这些快照。';
  ...
  String startupRecoverySnapshotConfirm(String when) {
    return '将聊天和设置恢复到 $when 的快照？快照之后的更改不会包含在内。现有附件文件和快照会保留，JO-AIClient 将重启以完成恢复。';
  }

  @override
  String get startupRecoverySnapshotReady => '快照已准备好，请重启 JO-AIClient 完成恢复。';
  ...
  String get scheduledTasksReliability =>
      '建议在电池设置中允许 JO-AIClient 后台运行。强行停止后需重新打开应用。错过的任务不会补跑，执行时间跟随设备时区。';
  ...
  String get scheduledTasksDesktopReliability =>
      '仅在 JO-AIClient 运行时执行，最小化或驻留托盘时也会继续。退出或电脑休眠期间错过的任务不会补运行，也不会自动启动应用。';
  ...
  @override
  String get mcpServerEditSheetNameHint => '我的 MCP';

  @override
  String get mcpServerEditSheetDefaultName => 'MCP';

  @override
  String get mcpServerEditSheetStdioCommandHint => 'npx';
  ...
  @override
  String get mcpServerEditSheetStdioWorkingDirectoryHint => '/root';

  @override
  String get mcpServerEditSheetStdioEnvNameHint => 'ENV_NAME';

  @override
  String get mcpServerEditSheetStdioEnvValueHint => '值';

  @override
  String get mcpServerEditSheetSseUrlHint => 'http://localhost:3000/sse';
  ...
  String get phoneControlAssistantHint =>
      '需要同时完成两项设置：在系统无障碍设置中启用“JO-AIClient 手机控制”，并在要使用的助手 → 本地工具中开启“手机控制”（也可从对话工具菜单开启）。每个助手单独配置，执行任务时请保持手机解锁。';
  ...
  String get phoneControlRestrictedHint =>
      '部分下载的 APK 需要先在应用信息右上角菜单中选择“允许受限制的设置”。点击打开 JO-AIClient 应用信息，完成后再返回无障碍设置。';
...
class AppLocalizationsZhHant extends AppLocalizationsZh {
  ...
  @override
  String get homePageDeleteMessage => '刪除目前分支';

  @override
  String get homePageDeleteMessageConfirm => '確定要刪除目前分支及其後續訊息嗎？其他分支會保留。';

  @override
  String get homePageDeleteMessageOnly => '刪除此則訊息';
  ...
  @override
  String get backupPageChatboxModernGroupName => 'Chatbox 匯入（≥1.22）';

  @override
  String get backupPageChatboxModernStarredGroupName => 'Chatbox 匯入（≥1.22）·置頂';

  @override
  String get backupPageChatboxModernNote =>
      'Chatbox 的人設與智慧體筆記不會匯入；會匯入供應商、助手、會話、訊息與檔案。';
  ...
  @override
  String get messageEditPageSaveAsBranch => '儲存為新分支';

  @override
  String get messageEditPageSaveAsBranchAndSend => '儲存為新分支並發送';
  ...
  @override
  String get messageEditCloseConfirmTitle => '關閉而不儲存？';

  @override
  String get messageEditCloseConfirmContent => '目前的修改將被捨棄。';
  ...
  @override
  String get messageMoreSheetCopyFromHereWithBranches => '從此處複製到新會話（保留分支）';
  ...
  @override
  String get conversationForkFailed => '無法複製會話';
  ...
  @override
  String sideDrawerMoveSelectedWithSkippedSnackbar(int moved, int skipped) {
    return '已移動 $moved 個話題，跳過 $skipped 個正在生成的話題';
  }
  ...
  @override
  String get modelDetailSheetOpenRouterShellToolDescription =>
      '在 Responses 模式中允許 OpenRouter 伺服器端 Shell 工具。';
  ...
  @override
  String get miniMapFullWindow => '全視窗顯示';

  @override
  String get miniMapRestoreWindow => '恢復視窗大小';

  @override
  String get miniMapActualSizeTooltip => '100%';

  @override
  String get miniMapFitHorizontalTooltip => '橫向全覽';
  ...
  @override
  String get memorySettingsInjectionMaxItemsSubtitle =>
      '某類記憶超過此上限時，只注入最新條目，其餘內容可透過 memory_search_profile 查詢。數值越大越完整，但會佔用更多 token。';
  ...
  @override
  String get memoryPromptEditMigrateSubtitle => '遷移時使用模型整理記憶措辭';

  @override
  String get memorySettingsMigrationBatchSizeSubtitle =>
      '每次模型請求處理的舊版記憶數量（1-24）';
  ...
  @override
  String get legacyMemoryMigrationContentOrganizeDescription =>
      '模型使用可編輯的遷移提示詞，對每條記憶分類並重新整理措辭。';

  @override
  String get legacyMemoryMigrationBatchSize => '每批條數';
  ...
  @override
  String legacyMemoryModeCacheWarning(String token) {
    return '舊版會把全部記憶內容與目前時間寫進系統提示詞，每輪都在變，無法命中 prompt cache，長對話成本更高。';
  }
  ...
  @override
  String get backupIncludeLocalSettingsOnSubtitle =>
      '視窗大小與位置、桌面快捷鍵、聊天字號等本機專屬設定隨備份一起帶走。';
  ...
  @override
  String get storageSpaceClearDisplacedDatabasesConfirmMessage =>
      '確定刪除這些保留的舊資料庫嗎？它們是 JO-AIClient 重建資料庫時留下的，可能是那些聊天記錄和設定僅存的一份。刪除後無法復原。';
  ...
  @override
  String get startupRecoveryDangerBody =>
      '重設會永久刪除本裝置上 JO-AIClient 的資料庫。請先匯出資料副本——重設同時會銷毀排查根本問題所需的證據。';
  ...
  @override
  String backupPageForwardCompatBody(int backupVersion, int currentVersion) {
    return '這份備份由更新版本的 JO-AIClient 建立（資料格式 $backupVersion，目前版本支援 $currentVersion），且未聲明舊版本能否讀取。\n\n你可以繼續匯入：目前版本不認識的內容會被略過，備份檔案本身不會被修改。但如果新版本改變了既有資料的儲存方式，部分內容可能會被錯誤匯入。\n\n更穩妥的做法是先升級 JO-AIClient。';
  }
  ...
  @override
  String get backupPageSchemaTooNewMessage =>
      '這份備份由更新版本的 JO-AIClient 建立，目前版本無法讀取。請先升級 JO-AIClient 後重試。';
  ...
  @override
  String get workspaceEnvRestartBanner => '請重新啟動 JO-AIClient 以完成安裝';
  ...
  @override
  String get workspaceEnvNativeExplanation =>
      '在桌面端，JO-AIClient 使用系統終端機，而不是 Linux 沙箱。';
  ...
  @override
  String get workspaceDesktopManagedHint => '由 JO-AIClient 為此專案建立並管理資料夾。';
  ...
  @override
  String get backgroundTaskTitle => 'JO-AIClient 任務';
  ...
  @override
  String get backgroundIconDefault => 'JO-AIClient 圖示';
  ...
  @override
  String get startupRecoverySnapshotBody =>
      '即使資料庫無法開啟，也可以選擇本機快照還原聊天和設定。請勿解除安裝 JO-AIClient，解除安裝會一併刪除這些快照。';
  ...
  @override
  String startupRecoverySnapshotConfirm(String when) {
    return '將聊天和設定還原到 $when 的快照？快照之後的變更不會包含在內。現有附件檔案和快照會保留，JO-AIClient 將重新啟動以完成還原。';
  }

  @override
  String get startupRecoverySnapshotReady => '快照已準備好，請重新啟動 JO-AIClient 完成還原。';
  ...
  @override
  String get scheduledTasksReliability =>
      '建議在電池設定中允許 JO-AIClient 背景執行。強制停止後需重新開啟應用程式。錯過的任務不會補跑，執行時間跟隨裝置時區。';
  ...
  @override
  String get scheduledTasksDesktopReliability =>
      '僅在 JO-AIClient 執行時運作，最小化或常駐系統匣時也會繼續。結束或電腦休眠期間錯過的任務不會補執行，也不會自動啟動應用程式。';
