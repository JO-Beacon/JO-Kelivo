...
void main() {
  ...
  group('OCR request messages', () {
    test('includes the configured system prompt', () {
    ...
    test('omits the system prompt when explicitly cleared', () {
  ...
  testWidgets('cancelled OCR does not continue with later images', (
    tester,
  ) async {
    var calls = 0;
    final service = OcrService(
  ...
  testWidgets('cancelled OCR is not returned as partial success', (
    tester,
  ) async {
    var calls = 0;
    final service = OcrService(
