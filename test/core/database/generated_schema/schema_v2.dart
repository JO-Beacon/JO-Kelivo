...
class MessageTreeEdgeRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  MessageTreeEdgeRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> conversationId = GeneratedColumn<String>(
    'conversation_id',
    aliasedName,
    false,
  ...
  @override
  MessageTreeEdgeRows createAlias(String alias) {
    return MessageTreeEdgeRows(attachedDatabase, alias);
  }
...
class ConversationTreeStateRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ConversationTreeStateRows(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> conversationId = GeneratedColumn<String>(
    'conversation_id',
    aliasedName,
    false,
  ...
  @override
  List<GeneratedColumn> get $columns => [conversationId, activeBranchId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  ConversationTreeStateRows createAlias(String alias) {
    return ConversationTreeStateRows(attachedDatabase, alias);
  }
...
class DatabaseAtV2 extends GeneratedDatabase {
  ...
  late final MessageTreeEdgeRows messageTreeEdgeRows = MessageTreeEdgeRows(
    this,
  );
  late final ConversationBranchRows conversationBranchRows =
      ConversationBranchRows(this);
  late final ConversationTreeStateRows conversationTreeStateRows =
      ConversationTreeStateRows(this);
