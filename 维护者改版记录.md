...
### 5. 同步 [原版](https://github.com/Chevey339/kelivo) 代码前的最低检查
...
13. [`.gitignore`](.gitignore) 是否仍忽略本地安装器和本地快捷方式。
14. 如果同步覆盖了 ARB 文件，必须重新补齐四个语言文件并运行本地化生成。
15. Release 是否写明对应上游版本和发布时间；如发布二进制，是否同时提供对应源码获取方式。
